  ...
  return <main className={s.terminal}>
    <div className={s.wrap}>
      <header className={s.topo}>
        ...
        <nav aria-label="Navegação"><Link href="/">◄ Arquivo</Link><Link href="/faccoes">Facções</Link><Link href="/linha-do-tempo">Linha do tempo</Link><Link href="/mundo">◍ Mundo</Link><Link href="/chat">chat</Link>{userId && <Link href="/perfil">perfil</Link>}{ehAdmin && <Link href="/admin/comunidade">moderação</Link>}</nav>
      </header>

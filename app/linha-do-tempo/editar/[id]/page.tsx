...
export default function EditarEventoPublico() {
       ...
       <PrecisaLogin>
        <header className="hd">
          <div className="hd-bar">
            ...
            <span className="hd-path">drukale://arquivo/linha-do-tempo/editar/{id}</span>
        ...
        {loading ? (
          ...
          <p className="vazio">
            {alvo ? 'este evento não é seu para editar' : `nenhum evento responde por "${id}"`} —{' '}
